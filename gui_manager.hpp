...
private:
    ...
    boost::shared_ptr<gcn::Button> show_gui_button, hide_gui_button, reset_simulation_button, reset_bathymetry_button, save_bathymetry_button, pause_simulation_button, save_inundation_button;
